            ...
            tinymce.init(
                Object.assign({},{
                    ...
                    images_upload_handler: function (blobInfo, success, failure) {
                        ...
                        xhr.onload = function() {
                            var json;
                            // $(arcLoading).find('.arc-loading-plugin.arc-auto').fadeOut(300, function () {
                            //     $(this).remove();
                            // });
                            $(".mce-throbber").remove();
