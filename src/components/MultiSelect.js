...
export default {
  ...
  watch: {
    ...
    value(val) {
      if (val != '' && val != null) this.isActive = true
  ...
  methods: {
    setStatus() {
      if (this.value != '' && this.value != null) this.isActive = true
      else {
        this.isActive = false
      }
    },
    ...
    switchList(on = true) {
      if (on) this.isExpanding = true
      else this.isExpanding = false
    },
    ...
    toggleItem(id) {
      ...
      if (!this.isSingle) {
        ...
        if (
          itemSelected &&
          this.selectAllId &&
          itemSelected.id == this.selectAllId
        ) {
