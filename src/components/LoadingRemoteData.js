...
export default {
  ...
  computed: {
    ...
    listClasses() {
      return (
        (this.searchList.length == 0 ? '' : 'active') +
  ...
  methods: {
    ...
    callAjax(value) {
      this.$http
        .post(this.url, { name: value }, { timeout: 10000 })
      ...
      this.searchList = [
        {
          id: 1,
          html:
            '<p>Anh Duan Nguyen</p><p class="club">Bayern Munich</p><p><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i></p>',
          keywords: 'Anh Duan Nguyen',
          thumbHtml: 'Anh Duan Nguyen',
          icon:
            'https://as01.epimg.net/img/comunes/fotos/fichas/deportistas/x/xab/large/900.png',
        },
      ]
    },
    removeLastTag() {
